...
## List all deposit {{ tag: 'GET', label: '/v1/deposit' }}
...
<Row>
    ...
    <Col sticky>
        <CodeGroup title="Request" tag="GET" label="/v1/deposit">
            ```typescript {{ title: 'axios' }}
            const response = axios.get('/v1/deposit', {
                params: {
                    page:1,
                    page_size: 10
                }
...
## Create deposit {{ tag: 'POST', label: '/v1/deposit' }}
